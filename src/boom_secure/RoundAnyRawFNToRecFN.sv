...
module RoundAnyRawFNToRecFN(
  ...
  wire        anyRound = io_in_sig[39] | (|(io_in_sig[38:0]));	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:116:{26,60}, :163:40, :165:36]
  wire [25:0] roundedSig = (roundingMode_near_even | io_roundingMode == 3'h4) & io_in_sig[39] | (io_roundingMode == 3'h2 & io_in_sign | io_roundingMode == 3'h3 & ~io_in_sign) & anyRound ? {1'h0, io_in_sig[64:40]} + 26'h1 & {25'h1FFFFFF, ~(roundingMode_near_even & io_in_sig[39] & ~(|(io_in_sig[38:0])))} : {1'h0, io_in_sig[64:41], io_in_sig[40] | io_roundingMode == 3'h6 & anyRound};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:89:53, :91:53, :92:53, :93:53, :94:53, :97:{27,42,63,66}, :105:31, :115:66, :116:{26,60}, :163:40, :165:36, :168:{38,67}, :169:31, :170:29, :172:16, :173:{49,57}, :174:{21,25,64}, :175:30, :176:35, :179:47, :180:42]
