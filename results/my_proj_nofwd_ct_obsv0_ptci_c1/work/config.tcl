...
# The following script was created on Mon Mar 23 21:53:13 2026
...
# BEGIN RTL COMMANDS
analyze -sv +define+RF_SIZE=4+RF_SIZE_LOG=2+MEMI_SIZE=16+MEMI_SIZE_LOG=4+MEMD_SIZE=4+MEMD_SIZE_LOG=2+ROB_SIZE=4+ROB_SIZE_LOG=2+BR_PREDICT=0+USE_DEFENSE_PARTIAL_STT=+PARTIAL_STT_USE_SPEC=+OBSV=0+INIT_VALUE=0+IMM_STALL= ./src/simpleooo/two_copy_top_ct_ptci_c1.v
...
abstract -init_value memd\[0]
abstract -init_value memd\[1]
abstract -init_value memd\[2]
abstract -init_value memd\[3]
